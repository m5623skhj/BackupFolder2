...
public :
	...
	UINT						BeforeRecvTPS;
	UINT						BeforeSendTPS;
	UINT						BeforeAcceptTPS;

	UINT						SendThreadLoop;
	UINT						AuthThreadLoop;
	UINT						GameThreadLoop;

	UINT						BeforeSendThreadLoop;
	UINT						BeforeAuthThreadLoop;
	UINT						BeforeGameThreadLoop;
...
protected :
	...
	virtual void GQCSFailed(int LastError, CSession *pSession) = 0;
...
private :
	...
	UINT												m_uiHeartBeatCheckMilliSecond;
